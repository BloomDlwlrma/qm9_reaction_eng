...
# ==============================================================================
# Main slurm function
# for debug, run run_batch_debugmanager.py (default: run_batch_manager.py)
# ==============================================================================
...
time python run_batch_debugmanager.py "${START_ID}" "${END_ID}" "${CONCURRENCY}" "${BASIS}" "${METHODS}"
